...
char g_table_name[64] = "map_ratings";
char g_current_map[64];
Database db;
ConVar g_cvars[CVAR_NUM_CVARS];
bool g_SQLite = false;
Menu g_admin_menu;
...
public OnPluginStart()
{
	...
	g_cvars[CVAR_DB_CONFIG] = CreateConVar("sm_maprate_db_config", "maprate", "Database configuration to use for Map Rate plugin");
